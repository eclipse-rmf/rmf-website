		...
		<div class="navbar">
			<div class="nav-collapse">
				<ul class="nav">
					...
					<li><a class="clickscroll" href="#downloadSection">Download</a></li>
...
To get started as a user, you can

<ul>
  <li><b>Get Started</b> - Check out the <a href="https://wiki.eclipse.org/Category:RMF/User_Guide">User Gude</a>.</li>
  <li><b>ProR Tutorial</b> - In particular, you may be interested in the <a href="https://wiki.eclipse.org/RMF/User_Guide/Tutorial">Tutorial</a>.</li>
  <li><b>Ask the Forum</b> - The <a href="http://www.eclipse.org/forums/index.php?t=thread&frm_id=230">user forum</a> is a good place for asking questions.
  <li><b>File a Bug</b> - You can <a href="https://bugs.eclipse.org/bugs/enter_bug.cgi?assigned_to=&blocked=&bug_file_loc=http%3A%2F%2F&bug_severity=normal&bug_status=NEW&comment=&contenttypeentry=&contenttypemethod=autodetect&contenttypeselection=text%2Fplain&data=&dependson=&description=&flag_type-1=X&flag_type-11=X&flag_type-12=X&flag_type-2=X&flag_type-4=X&flag_type-6=X&flag_type-7=X&flag_type-8=X&form_name=enter_bug&keywords=&maketemplate=Remember%20values%20as%20bookmarkable%20template&op_sys=All&product=MDT.RMF&qa_contact=&rep_platform=All&short_desc=&version=unspecified">submit a Bugzilla entry</a>.  Note that you nave to create an account to file bugs.</li>
...
<ul>
  <li><b>Contribute</b> - There are many ways for helping, we created a <a href="https://wiki.eclipse.org/Category:RMF/Contributor_Guide">Contributor Guide</a> for this purpose.</li>
  
  <li><b>Project Metadata</b> - Various statistics about the project can be found on the <a href="http://www.eclipse.org/projects/project.php?id=modeling.mdt.rmf">Eclipse RMF Project Page</a>.
  
  <li><b>Extend ProR</b> - To extend the functionality of ProR, you can <a href="https://wiki.eclipse.org/RMF/Contributor_Guide/Presentations">create so-called presentations</a>, which are plug-ins that provide custom renderers and other extensions.</li>
</ul>
...
<script language="JavaScript" src="http://feed2js.org//feed2js.php?src=http%3A%2F%2Fformalmind.com%2Fen%2Fblog%2Frss.xml&num=8&desc=250&date=y&targ=y&utf=y&html=p"  charset="UTF-8" type="text/javascript"></script>

    <noscript>
    <a href="http://feed2js.org//feed2js.php?src=http%3A%2F%2Fformalmind.com%2Fen%2Fblog%2Frss.xml&num=8&desc=250&date=y&targ=y&utf=y&html=y">View RSS feed</a>
    </noscript>
</div>
